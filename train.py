...
def train():   # TO RUN: python train.py --config configs/baseline_config.yaml
    ...
    # MPS support for Apple Silicon Mac
    ...
    writer = SummaryWriter(f"runs/{model_type}_experiment")
